...
namespace TempleTours
{
    public class Startup
    {
        ...
        public IConfiguration Configuration { get; set; }   //added set;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ToursDbContext>(options =>        //added
            {
                options.UseSqlite(Configuration["ConnectionStrings:TempleToursConnection"]);
            });

            services.AddScoped<IToursRepository, EFToursRepository>();  //added
        }
